...
<html lang="en">
  ...
  <head>
    ...
    <title>Descuentos Timbradas</title>
  ...
  <body id="page-top">
      ...
      <div id="content-wrapper" class="paddingBottom0">
        ...
        <div class="container-fluid" style="height: 90vh">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Descuentos Timbradas</li>
          </ol>
    ...
    <script src="<?php echo base_url();?>js/consultas/descuentos_timbradas.js"></script>
